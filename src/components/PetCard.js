...
const PetCard = (props) => {
  const onClickSelectPet = () => {
    props.selectPetCallback(props.pet)
  }

  const onClickRemovePet = () => {
    props.removePetCallback(props.pet)
  }
